...
{
    private string _username = "862e662e-e037-41be-94a0-d70132e47ed9";
    private string _password = "LgKmQN8jOP8v";
    private string _url = "https://gateway.watsonplatform.net/conversation/api";
    private string _workspaceId = "ba7a4ab7-5249-4c72-bf71-112e886a12eb";
    ...
    public void AskQuestion(string sttInput)
    {
