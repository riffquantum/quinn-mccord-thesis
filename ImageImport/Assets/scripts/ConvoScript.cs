        ...
        if (resp != null && (messageResponse.intents.Length > 0 || messageResponse.entities.Length > 0))
        {
            ...
            if (intent == "disable")
            {
                ...
                foreach (RuntimeEntity entity in messageResponse.entities)
                {
                    ...
                    if (entity.entity == "hulls")
                    {
                        GameObject hulls = GameObject.Find("Hulls");
                        hulls.SetActive(false);
                        Debug.Log("Hulls Disabled");
                        
                    }
                    if (entity.entity == "display")
                    {
                        GameObject trackDisplay = GameObject.Find("TrackDisplay");
                        trackDisplay.SetActive(false);
                    }
                    if (entity.entity == "channel")
                    {
                        string chanNum = entity.value.ToString();
                        GameObject chans = GameObject.Find(chanNum);
                        chans.SetActive(false);
                        Debug.Log("Channel " + chanNum + " disabled");
                    }
                }
            ...
            if (intent == "enable")
            {
                ...
                foreach (RuntimeEntity entity in messageResponse.entities)
                {
                    ...
                    if (entity.entity == "channel")
                    {
                        ...
                        GameObject chans = GameObject.Find(chanNum);
                        chans.SetActive(false);
                        Debug.Log("Channel " + chanNum + " enabled");
                    }
                }
            }
            else
